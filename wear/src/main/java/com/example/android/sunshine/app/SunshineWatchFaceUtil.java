...
/**
 * Created by joaobiriba on 25/11/15.
 */
public final class SunshineWatchFaceUtil {

    private static final String LOG_TAG = SunshineWatchFaceUtil.class.getSimpleName();

    /**
     * The {@link DataMap} key for {@link SunshineWatchFaceUtil} background color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_BACKGROUND_COLOR = "BACKGROUND_COLOR";

    /**
     * The {@link DataMap} key for {@link SunshineWatchFaceUtil} hour digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_HOURS_COLOR = "HOURS_COLOR";

    /**
     * The {@link DataMap} key for {@link SunshineWatchFaceUtil} minute digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_MINUTES_COLOR = "MINUTES_COLOR";

    /**
     * The {@link DataMap} key for {@link SunshineWatchFaceUtil} second digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    ...
    /**
     * Asynchronously fetches the current config {@link DataMap} for {@link SunshineWatchFaceUtil}
